...
function createCheck(checkName, annotations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const req = Object.assign(Object.assign({}, github.context.repo), { name: checkName, head_sha: github.context.sha, status: 'completed', conclusion: annotations.length > 0 ? 'failure' : 'success', output: {
                title: checkName,
                summary: `${annotations.length} errors(s) found`,
                annotations
            } });
        console.log(req);
        const res = yield octokit.checks.create(req);
        console.log(res);
    });
}
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Launch clangtidy
            yield exec.exec('tools/run-clang-tidy-in-ci.sh');
        }
        catch (error) {
