...
function runFlake8() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exec.exec('pip3', ['show', 'flake8', '-f']);
        let myOutput = '';
        let myError = '';
        let options = {
            listeners: {
...
function createCheck(checkData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield octokit.checks.create(Object.assign(Object.assign(Object.assign({}, github.context.repo), { name: checkName, sha: github.context.sha }), checkData));
    });
}
function run() {
    return __awaiter(this, void 0, void 0, function* () {
