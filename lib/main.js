...
function createCheck(checkName, annotations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield octokit.checks.create(Object.assign(Object.assign({}, github.context.repo), { name: checkName, head_sha: github.context.sha, status: 'completed', conclusion: annotations.length > 0 ? 'failure' : 'success', output: {
                title: checkName,
